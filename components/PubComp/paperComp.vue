            ...
            <div class="pub-detail">
                <div>
                    ...
                    <v-card-actions style="padding-top: 0">
                        <div v-if="props.paperURL" style="display: inline-block">
                            <UTooltip text="paper">
                        ...
                        <div v-if="props.githubURL" style="display: inline-block">
                            <UTooltip text="code">
                        ...
                        <div v-if="props.demoURL" style="display: inline-block">
