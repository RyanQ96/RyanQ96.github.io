<template>
  <div id="intro">
    ...
    <span class="intro-content">
      ...
      <br />
      <br />
      Beyond research, I’m the proud parent of two cats, Simba <UAvatar src="/simba.png" size="xl"></UAvatar>
      and Bingo <UAvatar src="/bingo.png" size="xl"></UAvatar>, and enjoy photography, badminton, and tennis.
    ...
    <div>
      <div style="display: flex; justify-content: space-between; margin: 0 auto; width: 50%;">
        <a href="mailto:qiu.580@osu.eud"><v-btn class="ma-2" color="red-lighten-2" variant="text">
            <svg style="height:1.5rem; transform: translate(0, 20%)" xmlns="http://www.w3.org/2000/svg" width="32"
        ...
        <a href="https://scholar.google.com/citations?user=yucgO7EAAAAJ&hl=zh-CN" target="_blank" rel="noopener"
          ...
          <v-btn class="ma-2" color="red-lighten-2" variant="text">
            <svg style="height:1.5rem; transform: translate(0, 20%);" xmlns="http://www.w3.org/2000/svg"
              viewBox="0 0 512 512">
              <path fill="currentcolor"
        ...
        <a href="https://www.linkedin.com/in/rui-qiu-231aa915b"><v-btn class="ma-2" color="red-lighten-2"
            variant="text">
            <svg style="height:1.5rem; transform: translate(0, 20%);" xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24">
              <path fill="currentColor"
