  ...
  <div id="intro">
    ...
    <span class="intro-content">
      Nice to meet you! I’m Rui Qiu (邱瑞), currently a fourth-year Ph.D. student in the <a
        href="https://sites.google.com/view/gravity-research-group/people" class="highlight">Gravity</a> research group at The Ohio State
      University, advised by Professor <a href="https://han-wei-shen.github.io/" class="highlight">Han-Wei Shen</a>. My research interests
      lie in visual analytics, explainable AI (XAI), large language models (LLMs), and agent-based systems.
      <br />
      <br />
      Beyond research, I’m the proud parent of two cats, Simba <v-avatar image="/simba.png" :size="catsize"></v-avatar>
      and Bingo <v-avatar image="/bingo.png" :size="catsize"></v-avatar>, and enjoy photography, badminton, and tennis.
