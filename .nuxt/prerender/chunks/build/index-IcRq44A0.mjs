import { useSSRContext, defineComponent, mergeProps, unref, computed, withCtx, createVNode, toDisplayString, createTextVNode } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderStyle } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/vue/server-renderer/index.mjs';
import { a as VCard } from './VCard-DRGf4iWt.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(`<div class="pub-card" data-v-6dca60cf${_scopeId}><div class="pub-detail" data-v-6dca60cf${_scopeId}><div data-v-6dca60cf${_scopeId}><h2 data-v-6dca60cf${_scopeId}><a class="title"${ssrRenderAttr("href", `/blogs/${props.id}`)} data-v-6dca60cf${_scopeId}>${ssrInterpolate(props.title)}</a></h2><div class="limited-content" data-v-6dca60cf${_scopeId}><p data-v-6dca60cf${_scopeId}>${ssrInterpolate(props.abstract)}</p></div><div style="${ssrRenderStyle({ "display": "flex" })}" data-v-6dca60cf${_scopeId}><div class="authors" data-v-6dca60cf${_scopeId}>Date: ${ssrInterpolate(props.date)} | </div> \xA0 <div class="authors" data-v-6dca60cf${_scopeId}>Author: ${ssrInterpolate(props.authors)}</div></div></div></div></div>`);
          } else {
            return [
...
const BlogComp = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6dca60cf"]]);
const BlogData = [
  {
    id: "fisher",
...
//# sourceMappingURL=index-IcRq44A0.mjs.map
