import { ref, computed, toRef, Text, createVNode, Transition, Fragment, withDirectives, mergeProps, resolveDirective, unref, shallowRef, resolveDynamicComponent, reactive } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/vue/index.mjs';
import { p as propsFactory, I as IconValue, m as makeComponentProps, j as makeTagProps, k as makeThemeProps, l as genericComponent, o as provideTheme, q as useIcon, s as useTextColor, t as useRender, v as flattenFragments, h as convertToUnit, x as makeRoundedProps, y as useProxiedModel, w as useRtl, z as useBackgroundColor, A as useRounded, B as clamp, E as getCurrentInstance, H as provideDefaults, J as createSimpleFunctional, K as makeBorderProps, L as useBorder, V as VImg, M as VDefaultsProvider, N as makeDimensionProps, O as makeElevationProps, P as useDimension, Q as useElevation, g as getCurrentInstanceName, e as useColor, f as destructComputed, i as includes, C as hasEvent, D as deepEqual, F as isObject, G as keyCodes } from './server.mjs';
...
function useLink(props, attrs) {
  ...
  const isActive = computed(() => {
    ...
    if (!link.value)
      return false;
    if (!props.exact)
      return (_a3 = (_a2 = link.value.isActive) == null ? void 0 : _a2.value) != null ? _a3 : false;
    if (!route.value)
      return (_b3 = (_b2 = link.value.isExactActive) == null ? void 0 : _b2.value) != null ? _b3 : false;
...
export { genOverlays as A, VIcon as B, Ripple as R, VAvatar as V, VCard as a, VCardTitle as b, VCardText as c, VCardSubtitle as d, VCardActions as e, flipSide as f, flipAlign as g, flipCorner as h, getAxis as i, makeVariantProps as j, useDensity as k, makeSizeProps as l, makeDensityProps as m, useSize as n, useIntersectionObserver as o, parseAnchor as p, makeLoaderProps as q, makeLocationProps as r, makePositionProps as s, makeRouterProps as t, useRouter as u, useLoader as v, useLocation as w, usePosition as x, useLink as y, useVariant as z };
//# sourceMappingURL=VCard-DRGf4iWt.mjs.map
