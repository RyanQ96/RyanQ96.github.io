import { reactive, ref, computed, toRef, watch, createVNode, Fragment, mergeProps, Teleport, withDirectives, vShow, resolveDirective, useSSRContext, defineComponent, unref, inject, watchEffect, nextTick, effectScope, onScopeDispose, shallowRef, provide, toRaw, readonly, warn, Transition, withCtx, createTextVNode, openBlock, createBlock, createCommentVNode, toDisplayString } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/vue/index.mjs';
import { ssrRenderAttrs, ssrRenderList, ssrRenderComponent, ssrRenderAttr, ssrInterpolate } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/vue/server-renderer/index.mjs';
import { u as useRouter, a as VCard, e as VCardActions, p as parseAnchor, f as flipSide, g as flipAlign, h as flipCorner, i as getAxis } from './VCard-DRGf4iWt.mjs';
import { V as VBtn } from './VBtn-DPxbZ9wV.mjs';
import { p as propsFactory, m as makeComponentProps, N as makeDimensionProps, k as makeThemeProps, $ as makeTransitionProps, l as genericComponent, E as getCurrentInstance, y as useProxiedModel, o as provideTheme, w as useRtl, z as useBackgroundColor, P as useDimension, Z as useToggleScope, t as useRender, h as convertToUnit, a0 as MaybeTransition, a1 as omit, a2 as getUid, W as templateRef, X as IN_BROWSER, _ as _export_sfc, R as isOn, S as eventName, f as destructComputed, Y as matchesSelector, T as consoleError, B as clamp, U as defer } from './server.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(ssrRenderComponent(VCard, mergeProps({
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          var _a;
          if (_push2) {
            _push2(`<div class="pub-card" data-v-6a035611${_scopeId}><div class="pub-img" data-v-6a035611${_scopeId}><img${ssrRenderAttr("src", props.teaserURL)} cover class="teaser" data-v-6a035611${_scopeId}></div><div class="pub-detail" data-v-6a035611${_scopeId}><div data-v-6a035611${_scopeId}><h2 data-v-6a035611${_scopeId}><a class="title"${ssrRenderAttr("href", props.paperURL)} data-v-6a035611${_scopeId}>${ssrInterpolate(props.title)}</a></h2><div class="authors" data-v-6a035611${_scopeId}>${(_a = authors.value) != null ? _a : ""}</div><div class="journal" data-v-6a035611${_scopeId}>${ssrInterpolate(props.journal)}</div>`);
            _push2(ssrRenderComponent(VCardActions, { style: { "padding-top": "0" } }, {
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  if (props.githubURL) {
                    _push3(`<div data-v-6a035611${_scopeId2}><a${ssrRenderAttr("href", props.githubURL)} data-v-6a035611${_scopeId2}>`);
                  ...
                  if (props.paperURL) {
                    _push3(`<div data-v-6a035611${_scopeId2}>`);
                    if (props.paperURL) {
                      _push3(`<a${ssrRenderAttr("href", props.githubURL)} data-v-6a035611${_scopeId2}>`);
                      _push3(ssrRenderComponent(VBtn, {
                        class: "ma-2",
              ...
              createVNode("div", { class: "pub-card" }, [
                ...
                createVNode("div", { class: "pub-detail" }, [
                  createVNode("div", null, [
                    ...
                    createVNode(VCardActions, { style: { "padding-top": "0" } }, {
                      default: withCtx(() => [
                        props.githubURL ? (openBlock(), createBlock("div", { key: 0 }, [
                          createVNode("a", {
                            href: props.githubURL
...
const paperComp = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-6a035611"]]);
const jsonData = [
  {
...
//# sourceMappingURL=index-B6_BS1AT.mjs.map
