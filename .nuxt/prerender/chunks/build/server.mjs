import { version as version$1, ref, watchEffect, watch, getCurrentInstance as getCurrentInstance$1, createVNode, mergeProps, defineComponent as defineComponent$1, provide, shallowReactive, h, inject as inject$1, Suspense, nextTick, Fragment, Transition, toRefs, toRef, shallowRef, computed, useSSRContext, hasInjectionContext, unref, onScopeDispose, capitalize, camelize, toRaw, reactive, TransitionGroup, isRef, withDirectives, resolveDirective, readonly, Text, withCtx, createApp, effectScope, getCurrentScope, warn, vShow, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, resolveComponent, createTextVNode, defineAsyncComponent, isReadonly, isShallow, isReactive } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/vue/index.mjs';
import { $fetch } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/ofetch/dist/node.mjs';
...
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderSuspense, ssrRenderVNode } from 'file:///Users/qiurui/Desktop/SF/personsal-web/RyanQ96.github.io/node_modules/vue/server-renderer/index.mjs';
...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import('./blog-CkxKB-DW.mjs')
  },
  {
    name: "cv",
    path: "/cv",
    component: () => import('./cv-DgMNfoRn.mjs')
  },
  {
    name: "index",
    path: "/",
    component: () => import('./index-VPuwVgGf.mjs')
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import('./portfolio-MtS0dc7M.mjs')
  },
  {
    name: "pub",
    path: "/pub",
    component: () => import('./pub-BP2nKuJ0.mjs')
  }
];
...
const _imports_1 = "" + __buildAssetsURL("Rui Official.CbYfKw-6.jpg");
...
function useTextColor(props, name) {
  const colors = computed(() => ({
    text: isRef(props) ? props.value : null
  }));
  const {
...
function useBackgroundColor(props, name) {
  const colors = computed(() => ({
    background: isRef(props) ? props.value : null
  }));
  const {
  ...
  _push(ssrRenderComponent(VAppBar, {
    ...
    default: withCtx((_, _push2, _parent2, _scopeId) => {
      if (_push2) {
        ...
        _push2(ssrRenderComponent(_component_router_link, { to: "/portfolio" }, {
          default: withCtx((_2, _push3, _parent3, _scopeId2) => {
            if (_push3) {
              _push3(ssrRenderComponent(VToolbarTitle, { class: "nav-title title-mini" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import('./error-404-D76MFCer.mjs'));
    const _Error = defineAsyncComponent(() => import('./error-500-DvNu8DuO.mjs'));
