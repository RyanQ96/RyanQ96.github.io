import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, ref, watchEffect, watch, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineAsyncComponent, computed, onScopeDispose, toRefs, capitalize, Fragment, warn, provide, defineComponent as defineComponent$1, camelize, createVNode, mergeProps, readonly, Suspense, nextTick, Transition, onServerPrefetch, useSSRContext, useAttrs, toValue, resolveDynamicComponent, TransitionGroup, withDirectives, resolveDirective, vShow, resolveComponent, withCtx, createTextVNode, onErrorCaptured, createApp } from "vue";
...
import { defu, createDefu, defuFn } from "defu";
...
import { _api, disableCache, addAPIProvider, getIcon, loadIcons, Icon } from "@iconify/vue";
import { ssrRenderComponent, ssrRenderAttrs, ssrRenderVNode, ssrRenderClass, ssrInterpolate, ssrRenderSlot, ssrRenderSuspense } from "vue/server-renderer";
...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/blog-DdXWc1-H.js")
  },
  {
    name: "blogs-fisher",
    path: "/blogs/fisher",
    component: () => import("./_nuxt/fisher-B4PARLlk.js")
  },
  {
    name: "cv",
    path: "/cv",
    component: () => import("./_nuxt/cv-CheAq3VV.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-kVA_9YBQ.js")
  },
  {
    name: "projects",
    path: "/projects",
    component: () => import("./_nuxt/projects-P8inG6No.js")
  },
  {
    name: "pub",
    path: "/pub",
    component: () => import("./_nuxt/pub-C_f7u2ed.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-DoHJmQHn.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-BVQ8Dknw.js"));
...
export {
  ...
  IconValue as I,
  createSimpleFunctional as J,
  makeBorderProps as K,
  useBorder as L,
  VDefaultsProvider as M,
  makeDimensionProps as N,
  makeElevationProps as O,
  useDimension as P,
  useElevation as Q,
  __nuxt_component_0 as R,
  arrow as S,
  mergeConfig as T,
  appConfig as U,
  VImg as V,
  ...
  entry$1 as default,
  useColor as e,
  destructComputed as f,
  getCurrentInstanceName as g,
  convertToUnit as h,
  includes as i,
  makeTagProps as j,
  makeThemeProps as k,
  ...
  useRtl as w,
  makeRoundedProps as x,
  useProxiedModel as y,
  useBackgroundColor as z
};
