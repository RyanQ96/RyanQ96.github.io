import { effectScope, shallowReactive, reactive, getCurrentScope, hasInjectionContext, getCurrentInstance as getCurrentInstance$1, inject as inject$1, toRef, version as version$1, unref, ref, watchEffect, watch, h, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, onScopeDispose, Fragment, computed, toRefs, warn, provide, defineComponent as defineComponent$1, capitalize, camelize, createVNode, mergeProps, readonly, Suspense, nextTick, Transition, TransitionGroup, withDirectives, resolveDirective, vShow, Text, resolveComponent, withCtx, createTextVNode, useSSRContext, defineAsyncComponent, onErrorCaptured, onServerPrefetch, resolveDynamicComponent, createApp } from "vue";
...
const _routes = [
  {
    name: "blog",
    path: "/blog",
    component: () => import("./_nuxt/blog-CkxKB-DW.js")
  },
  {
    name: "cv",
    path: "/cv",
    component: () => import("./_nuxt/cv-DgMNfoRn.js")
  },
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-VPuwVgGf.js")
  },
  {
    name: "portfolio",
    path: "/portfolio",
    component: () => import("./_nuxt/portfolio-MtS0dc7M.js")
  },
  {
    name: "pub",
    path: "/pub",
    component: () => import("./_nuxt/pub-BP2nKuJ0.js")
  }
];
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-D76MFCer.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-DvNu8DuO.js"));
