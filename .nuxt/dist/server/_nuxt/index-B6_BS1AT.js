import { ref, computed, watch, onScopeDispose, nextTick, inject, watchEffect, effectScope, mergeProps, shallowRef, reactive, provide, readonly, toRaw, warn, toRef, createVNode, Fragment, Teleport, withDirectives, vShow, resolveDirective, Transition, defineComponent, withCtx, createTextVNode, openBlock, createBlock, createCommentVNode, toDisplayString, useSSRContext, unref } from "vue";
import { ssrRenderComponent, ssrRenderAttr, ssrInterpolate, ssrRenderAttrs, ssrRenderList } from "vue/server-renderer";
import { p as parseAnchor, f as flipSide, b as flipAlign, c as flipCorner, g as getAxis, u as useRouter, V as VCard, d as VCardActions } from "./VCard-DRGf4iWt.js";
import { V as VBtn } from "./VBtn-DPxbZ9wV.js";
import { R as isOn, S as eventName, p as propsFactory, f as destructComputed, T as consoleError, h as convertToUnit, B as clamp, U as defer, E as getCurrentInstance, W as templateRef, X as IN_BROWSER, Y as matchesSelector, Z as useToggleScope, m as makeComponentProps, N as makeDimensionProps, k as makeThemeProps, $ as makeTransitionProps, l as genericComponent, y as useProxiedModel, o as provideTheme, w as useRtl, z as useBackgroundColor, P as useDimension, t as useRender, a0 as MaybeTransition, a1 as omit, a2 as getUid, _ as _export_sfc } from "../server.mjs";
class Box {
  constructor(_ref) {
    let {
      x,
...
//# sourceMappingURL=index-B6_BS1AT.js.map
